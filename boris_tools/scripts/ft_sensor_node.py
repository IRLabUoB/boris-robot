...
def main():
    ...
    ft_topic_raw = rospy.get_param("ft_topic","left_arm/ft_sensor_raw")
    ft_topic = rospy.get_param("ft_topic","left_arm/ft_sensor")
    ft_topic_pred = rospy.get_param("ft_topic","left_arm/ft_sensor_pred")
