#include "boris_controllers/DualArms.h"
...
void DualArms::init()
{
	...
	sub_command_right_ = nh.subscribe("/right_arm/boris_bridge_controller/commandCart_right",1,&DualArms::commandCart_right_,this);
	...
	pub_torques_right_arm_ = nh.advertise<sensor_msgs::JointState>("/right_arm/boris_bridge_controller/command_torques", 1);
	pub_torques_left_arm_ = nh.advertise<sensor_msgs::JointState>("/left_arm/boris_bridge_controller/command_torques", 1);
	pub_error_right_arm_ = nh.advertise<sensor_msgs::JointState>("/right_arm/boris_bridge_controller/error", 1);
