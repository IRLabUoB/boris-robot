...
#include <boris_controllers/cartesian_impedance_boris_controller.h>

namespace boris_controllers {

CartesianImpedanceBorisController::CartesianImpedanceBorisController() {
    ROS_WARN("BORIS Constructor end");
...
bool CartesianImpedanceBorisController::init(hardware_interface::EffortJointInterface *robot, ros::NodeHandle &n)
{
    ROS_WARN("BORIS init");
    ...
    for (int i = 0; i < joint_handles_.size(); ++i) {
        ...
        ROS_WARN("BORIS init 108");

    typedef  const std_msgs::Float64MultiArray::ConstPtr& msg_type;
    sub_stiffness_ = nh_.subscribe<CartesianImpedanceBorisController, msg_type>("stiffness", 1, boost::bind(&CartesianImpedanceBorisController::setParam, this, _1, &K_, "K"));
    sub_damping_ = nh_.subscribe<CartesianImpedanceBorisController, msg_type>("damping", 1, boost::bind(&CartesianImpedanceBorisController::setParam, this, _1, &D_, "D"));
    sub_add_torque_ = nh_.subscribe<CartesianImpedanceBorisController, msg_type>("additional_torque", 1, boost::bind(&CartesianImpedanceBorisController::setParam, this, _1, &tau_des_, "AddTorque"));
    sub_posture_ = nh_.subscribe("command", 1, &CartesianImpedanceBorisController::command, this);

        ROS_WARN("BORIS init 116");
...
void CartesianImpedanceBorisController::starting(const ros::Time& time)
{
            ROS_WARN("BORIS starting");
...
void CartesianImpedanceBorisController::update(const ros::Time& time, const ros::Duration& period)
{
...
void CartesianImpedanceBorisController::command(const std_msgs::Float64MultiArray::ConstPtr &msg) {
    if (msg->data.size() == 0) {
...
void CartesianImpedanceBorisController::setParam(const std_msgs::Float64MultiArray_< std::allocator< void > >::ConstPtr& msg, KDL::JntArray* array, std::string s)
{
...
PLUGINLIB_EXPORT_CLASS( boris_controllers::CartesianImpedanceBorisController, controller_interface::ControllerBase)
