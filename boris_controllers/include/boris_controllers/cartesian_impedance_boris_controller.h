...
#ifndef BORIS_CONTROLLERS__CARTESIAN_INPEDANCE_CONTROLLER_H
#define BORIS_CONTROLLERS__CARTESIAN_INPEDANCE_CONTROLLER_H

#include "boris_controllers/KinematicChainControllerBase.h"
...
namespace boris_controllers
{
    ...
    class CartesianImpedanceBorisController: public controller_interface::KinematicChainControllerBase<hardware_interface::EffortJointInterface>
    {
    public:

        CartesianImpedanceBorisController();
        ~CartesianImpedanceBorisController();
